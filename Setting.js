...
global.owner = process.env.OWNER_NUMBER  || '94766859177' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "94766859177" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || ''04_04_2024_SIGMA_MD_mtCsKyc1_MAHER_ZUBAIR              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'nuwa',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `nuwa`, // ADD YOUR NAME
  ...
  packname:  process.env.PACK_NAME  || "nuwa" ,          // ADD YOUR STICKER PACKNAME
